...
function Addcoatingapplicationline() {
  ...
  const handleSubmit = async (e, value) => {
    ...
    try {
      ...
      navigate(`/listcoatingapplicationline?menuId=${menuId}`);
    } catch (error) {
              ...
              <div className="row">
                <div className="col-md-12 col-sm-12 col-xs-12">
                  <ul>
                    ...
                    <li><b style={{ color: '#fff' }}>/&nbsp;</b> <Link to={`/listcoatingapplicationline?menuId=${menuId}`}> Coating Application Line List</Link></li>
