...
function AssignLabFieldList() {
    ...
    const handleViewClick = (row) => {
        navigate(`/assignfieldlabtest?moduleId=${moduleId}&menuId=${menuId}&action=view&test=${LabField}&year=${encryptData(row.year)}&processSheetId=${encryptData(row.procsheet_id)}&test_run_id=${encryptData(row.pm_test_run_id)}&type=${encryptData(row.pm_test_type)}`);
    };

    const handleEdit = (row) => {
        navigate(`/assignfieldlabtest?moduleId=${moduleId}&menuId=${menuId}&action=edit&test=${LabField}&year=${encryptData(row.year)}&processSheetId=${encryptData(row.procsheet_id)}&test_run_id=${encryptData(row.pm_test_run_id)}&type=${encryptData(row.pm_test_type)}`);
    };
