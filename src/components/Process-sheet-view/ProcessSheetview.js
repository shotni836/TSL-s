...
function ProcessSheetview() {
  ...
  let projectid1 = decryptData(projectid)
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      let pm_processsheet_id1 = decryptData(pm_processsheet_id)
      ...
      if (ViewType === "onhandleApproveClick") {
        ...
        setFormData({
          ...formData,
          pm_project_id: projectid1,
          pm_processsheet_id: pm_processsheet_id1,
          pm_approver_type: "1",
        });
      }
