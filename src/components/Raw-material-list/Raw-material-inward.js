...
function RawMaterialInwardList() {
    ...
    const handleViewClick = (material) => {
        navigate(`/inspection-test/menuId=24&action=view&id=${material.pm_inspection_id}`);
    };

    const handleFirstLevelApproval = (material) => {
        navigate(`/inspection-test/menuId=24&pm_Approve_level=first&id=${material.pm_inspection_id}`);
    };

    const handleEdit = (material) => {
        navigate(`/rawmaterialinspection?menuId=24&action=edit&id=${material.pm_inspection_id}`);
    };
                            ...
                            <div className='row'>
                                <div className='col-md-12 col-sm-12 col-xs-12'>
                                    <ul>
                                        ...
                                        <b style={{ color: '#fff' }}>/ &nbsp;</b>
                                        <li><Link to='/inspectiontesting?menuId=24'>Raw Material Test & Inspection</Link></li>
