  ...
  const handleSubmit = async (e, value) => {
    ...
    try {
      ...
      if (response.data.responseCode == "1000" || response.data.responseCode == "100") {
        ...
        navigate(`/listblastingline?moduleId=${moduleId}&menuId=${menuId}`);
      }
    } catch (error) {
              ...
              <div className="row">
                <div className="col-md-12 col-sm-12 col-xs-12">
                  <ul>
                    ...
                    <b style={{ color: '#fff' }}>/ &nbsp;</b>
                    <li> <Link to={`/listblastingline?moduleId=${moduleId}&menuId=${menuId}`}> Blasting Line List </Link> <b style={{ color: '#fff' }}></b></li>
