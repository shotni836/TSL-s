...
function Beforeprocesslabqcofficerapproved() {
                                ...
                                <div className='row'>
                                    <div className='col-md-12 col-sm-12 col-xs-12'>
                                        <ul>
                                            ...
                                            <li><h1> / &nbsp; Before Process Lab Testing (QC Officer) (Approve / Reject) </h1></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div className="row m-0">
                                                <div className="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div className="radio-buttons">
                                                        ...
                                                        <Link to='/beforeprocesslabqcofficerlist' className="SubmitBtn">Submit</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
export default Beforeprocesslabqcofficerapproved