...
function Beforeprocesslabqcofficerlist() {
    ...
    const [data, setData] = useState([
        ...
        { sno: 7, clientName: 'M/s Indian Oil Corporation Limited', projectName: 'HPCL', processSheet: 'TSL/PSC/EXT/3LPE/GAIL/MNJPL/2022-11', testDate: '2022-11-01', timing: '09:30 AM', testing: 'Test 7', status: 'P', pending: 'QA' },
                                ...
                                <div className="row">
                                    <div className='col-md-12 col-sm-12 col-xs-12'>
                                        <div className='RawmateriallistTables'>
                                            <h4>Before Process Lab Testing <span>- QC Officer List page</span></h4>
                                                ...
                                                <table className="QCofficerTable">
                                                    <thead>
                                                        <tr style={{ background: 'rgb(90, 36, 90)' }}>
                                                            ...
                                                            <th style={{ minWidth: '120px' }}>Project Name</th>
                                                            <th style={{ minWidth: '110px' }}>Process Sheet No.</th>
                                                            <th style={{ minWidth: '100px' }}>Test Date</th>
                                                            <th style={{ minWidth: '110px' }}>Timing</th>
                                                            <th style={{ minWidth: '90px' }}>Testing</th>
                                                        ...
                                                        {displayedData.length === 0 ? (
                                                            ...
                                                            displayedData.map((row) => (
                                                                <tr key={row.sno} style={getRowColorClass(row.status)}>
                                                                    ...
                                                                    <td>{row.testing}</td>
                                                                    <td>
                                                                        <Link to={row.status === 'P' ? '/beforeprocesslabqcofficerapproved' : '/beforeprocesslabqcofficer'} target='_blank'>
                                                                            <i className="fas fa-eye"></i>
                                                                        </Link>
                                                                        {row.status === 'P' && (
                                                                            <Link to='/beforeprocesslabqcofficerapproved' target='_blank' style={{ color: '#FFA100', padding: '0px' }}>Pending ({row.pending})</Link>
                                                                        )}
                                                                        {row.status === 'A' && (
...
export default Beforeprocesslabqcofficerlist;