                                        ...
                                        <div className='InspectiontestingDrowpdown'>
                                            <div className="dropdown">
                                                ...
                                                <ul className="dropdown-menu">
                                                    <li>
                                                        <Link to={`/rawmaterialinwardlist?moduleId=${moduleId}&menuId=${menuId}`} className='dropdown-item'>
                                                            Raw Material Inward
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link to={`/rawmateriallist?moduleId=${moduleId}&menuId=${menuId}&testingtype=${encryptData(605)}`} className='dropdown-item'>
                                            ...
                                            <div className="dropdown">
                                                <Link className="dropdown-toggle" to={`/rawmateriallist?moduleId=${moduleId}&menuId=${menuId}&testingtype=${encryptData(607)}`}>Before Lab Testing</Link>
                                            </div>
                                            ...
                                            <div className="dropdown">
                                                ...
                                                <ul className="dropdown-menu">
                                                    <li>
                                                        <Link to={`/assignfieldlabtestlist?moduleId=${moduleId}&menuId=${menuId}&test=Lab`} className='dropdown-item'>
                                                            Assign Lab Test on Pipe
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link to={`/rawmateriallist?moduleId=${moduleId}&menuId=${menuId}&testingtype=${encryptData(608)}`} className='dropdown-item'>
                                                            Lab Testing
                                                        </Link>
                                                    </li>
                                                </ul>
                                            ...
                                            <div className="dropdown">
                                                ...
                                                <ul className="dropdown-menu">
                                                    <li>
                                                        <Link to={`/assignfieldlabtestlist?moduleId=${moduleId}&menuId=${menuId}&test=Field`} className='dropdown-item'>
                                                            Assign Field Test on Pipe
                                                        </Link>
                                                    </li>
                                                    <li>
                                                        <Link to={`/rawmateriallist?moduleId=${moduleId}&menuId=${menuId}&testingtype=${encryptData(609)}`} className='dropdown-item'>
                                                            Field Testing
                                                        </Link>
                                                    </li>
                                                </ul>
