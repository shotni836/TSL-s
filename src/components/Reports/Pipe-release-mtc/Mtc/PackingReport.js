...
function Packingreport() {
    ...
    async function callWitness() {
        try {
            const response1 = await axios.get(`${Environment.BaseAPIURL}/api/User/GetEmployeeTypeWithNameMTC?p_procsheet_id=${pm_processSheet_id1}&runid=${Id}&rtype=1`);
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(`${Environment.BaseAPIURL}/api/User/GetInspectedByAcceptedByDetailsMTC?runid=${Id}&p_procsheet_id=${pm_processSheet_id1}&rtype=1`);
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            if (response.data === 100) {
                ...
                navigate(`/packinglist?menuId=23`);
            } else {
