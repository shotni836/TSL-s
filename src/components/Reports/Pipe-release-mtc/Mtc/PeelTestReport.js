...
function PeelTestReports() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                if (tstmaterialid) {
                    const [id1, id2, id3, id4] = tstmaterialid.split('&');
                    const response = await axios.get(`${Environment.BaseAPIURL}/api/User/proc_Get_PeelTestReport_ForMtc?pm_procsheet_id=${id1}&pipecode=${id2}&rtype=${encryptData(1)}&testid=${encryptData(1433)}`, {
                        headers: {
    ...
    const emptyRows = 3 - testDetails.length;
    return (
        <>
            {
                loading ? (
                    ...
                    <div className='bond-strength-test-only'>
                                                                ...
                                                                <div className='col-md-12 col-sm-12 col-xs-12'>
                                                                    <div id='custom-scroll'>
                                                                        <table>
                                                                            ...
                                                                            <tbody className='peel-test-report'>
...
export default PeelTestReports;